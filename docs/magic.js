...
var pages = {
  '/cases/': function cases(state) {
    return [h1(state.title), p(state.description), GitBadges('magic/cases'), h3({
      id: 'install'
    }, 'install'), p('be in a nodejs project'), Pre('npm i --save-dev @magic/cases'), h3({
      id: 'import'
    }, 'import'), Pre("\nimport cases from '@magic/cases'\n  "), h3({
      id: 'usage'
    }, 'usage'), p('@magic/cases supports 4 case types: snake_case, kebab-case, camelCase, and PascalCase'), h4({
      id: 'usage-camel'
